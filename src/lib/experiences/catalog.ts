...
export const experienceCatalog: Record<string, ExperienceCatalogEntry> = {
  "ai-director-os": {
    ...
    fileHints: [
      ...
      { path: "server/services/aiQualityReview.ts", purpose: "品質審核", stage: "審核" },
  ...
  framelab: {
    ...
    fileHints: [
      ...
      { path: "src/lib/domain/repair-planner.ts", purpose: "修復規劃", stage: "修復" },
  ...
  planform: {
    ...
    fileHints: [
      ...
      { path: "src/core/corridorGeometry.ts", purpose: "走廊編輯幾何", stage: "場地" },
      { path: "src/core/spatialKnowledge.ts", purpose: "可引用設計依據（非法規認證）", stage: "限制" },
      { path: "src/core/rehearsal.ts", purpose: "場前彩排", stage: "動線" },
  ...
  "hermes-console": {
    ...
    fileHints: [
      ...
      { path: "docs/LUMEN.md", purpose: "Lumen MCP；GitHub 網址不是 MCP", stage: "工具" },
      { path: "docs/FRAMELAB.md", purpose: "FrameLab MCP", stage: "工具" },
      { path: "docs/DUIGAO.md", purpose: "對稿 MCP", stage: "工具" },
      { path: "docs/PLANFORM_MCP.md", purpose: "PLANFORM MCP", stage: "工具" },
      { path: "docs/ATLAS_MCP.md", purpose: "場圖 Atlas MCP；GitHub 網址不是 MCP", stage: "工具" },
    ],
  },
  "tku-zen-ai": {
    mode: "conversation-preview",
