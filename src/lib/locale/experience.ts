...
export const experienceChrome = {
  zh: {
    ...
    sourcePublicEmbed: "來源標記：公開嵌入模式 · 未宣稱 Connect 已連線",
    sourceCanvaEmbed: "來源標記：Canva 公開嵌入 · 未宣稱 Connect 已連線",
  ...
  en: {
    ...
    sourcePublicEmbed: "Source mark: public embed mode · not claiming Connect is linked",
    sourceCanvaEmbed: "Source mark: Canva public embed · not claiming Connect is linked",
